program TeilchenMitRotation
  ...
  Ms = 1000                  ![kg] Masse von Saturn und Rhea sollen gleich sein, sodass der...  
  Mr = 1000                  ![kg] ...Lagrangepunkt von beiden Koerper gleichweit entfernt ist
  omegaz = 1.6096071e-5      ![1/s]
  gamma = 6.67428e-11        ![m³/kg*s²]
  alpha= 0.0                 ![rad] Das Teilchen wird in einem Winkel von 45° herausgeschlagen
  ...
  xs = 100.0                             ![m] Teilchen befinde im Lagrangepunkt
  ys = 0.0                             ![m]
  zs = 0.0                             ![m]
  ...
  xr = 100.0                             ![m] Teilchen befinde im Lagrangepunkt
  yr = 0.0                             ![m]                
  zr = 0.0                             ![m]                             
  v_xr = 0.0                           !Geschwindigkeit des Teilchen bei t= 0s ist Null
  v_yr = 0.0
  v_zr = 0.0  
...
end program TeilchenMitRotation
